...
const DoctorCard = ({doctor}) => {
    const {name,avgRating,totalRating,photo,specialization,experiences, totalPatients,hospital}=doctor;
  return (
    ...
    <div className="mt-2 lg:mt-4 flex items-center justify-between ">
        ...
        <div className='flex items-center gap-[6px]'>
            ...
            <span className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400] text-textColor text-headingColor'>({totalRating})</span>
