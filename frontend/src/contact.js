            ...
            <div className="contact-box">
              ...
              <div className="informations">
                <div className="single-info">
                  ...
                  <div className="info">
                    <a href="tel:05661111985" className={`${theme === "dark" ? "text-light text-hover" : ""}`}>+91 9348333339</a>
                    <a href="tel:06571111576" className={`${theme === "dark" ? "text-light text-hover" : ""}`}>+971 502056495</a>
                  </div>
                </div>
                <div className="single-info">
                  <div className="icon">
                  ...
                  <div className="info">
                    <a href="mailto:medicare@gmail.com" className={`${theme === "dark" ? "text-light text-hover" : ""}`}>medicare@gmail.com</a>
