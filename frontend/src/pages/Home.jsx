   ...
   <section>
    <div className='container'>
      <div className='lg:w-[470px] mx-auto'>
        <h2 className='heading text-center'>Providing the best medical treatment</h2>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
        <div className='py-[30px] px-5'>
          ...
          <div className="mt-[30px]">
            <h2 className='text-[26px] leading-9 text-textColor mt-4  font-[700] text-center'>Find a  Doctor</h2>
            <p className='text-[26px] leading-7 text-center'>World-class care for everyone. Our health system offers unmatched, expert health care.</p>
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className="mt-[30px]">
            <h2 className='text-[26px] leading-9 text-textColor mt-4  font-[700] text-center'>Find Location</h2>
            <p className='text-[26px] leading-7 text-center'>World-class care for everyone. Our health system offers unmatched, expert health care.</p>
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
            <BsArrowRight className='group-hover:text-white w-6 h-5' />
        ...
        <div className='py-[30px] px-5'>
          ...
          <div className="mt-[30px]">
            <h2 className='text-[26px] leading-9 text-textColor mt-4  font-[700] text-center'>Book Appointment</h2>
            <p className='text-[26px] leading-7 text-center'>World-class care for everyone. Our health system offers unmatched, expert health care.</p>
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
            <BsArrowRight className='group-hover:text-white w-6 h-5' />
    ...
    <div className='container'>
      <div className='xl: w-[470px] mx-auto'>
        ...
        <p className='text__para text-center'>
          World Class Health Services for Everyone.Our health System offers unmatched, expert health care.
        </p>
                    ...
                    <ul className='pl-4'>
                        <li className="text__para">
                            ...
                            3. View our physicians who are accepting new patients,
                               use online scheduling tool to select an appointment time.
                            </li>
                    </ul>
...
<section>
  <div className="container">
    <div className="xl:w-[470px] mx-auto">
      ...
      <p className="text__para text-center">
        World-class  for everyone. Our health System offfers unmatched, expert health care
      </p>
    </div>
