    ...
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
         ...
         <div className="addTodo my-5 flex flex-col gap-4">
          <h2 className='text-2xl font-bold'>Add goal & activities
          </h2>
          <div className="flex">
          ...
          <button onClick={handleSend} disabled={todo.length<=3} className='bg-violet-800 mx-2 rounded-full hover:bg-violet-950 disabled:bg-violet-500 p-4 py-2 text-sm font-bold text-white'>Send</button>
          </div>
         </div>
         ...
         <div className="todos">
          {todos.length ===0 && <div className='m-5'>No Goals to display</div> }
          {todos.map(item=>{
