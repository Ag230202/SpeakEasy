  ...
  return (
    <div>
      ...
      <form action="" >
          ...
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              >
                ...
                <option value="Geriatric SLP">Geriatric SLP</option>
                <option value="Fluency Therapist">Fluency Therapist</option>
                <option value="Voice Therapist">Voice Therapist</option>
                <option value="Articulation Therapist">Articulation Therapist</option>
              </select>
            </div>
            <div>
        ...
        <div className="mb-5 ">
              <p className="form__label">Experieces</p>
              ...
              {formData.timeSlots?.map((item, index) => (
                ...
                <div>
                  <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px]  gap-5">
                    ...
                    <div>
                      <p className="form__label">Ending Tine*</p>
                      <input type="time" name="endingTime" value={item.endingTime} className="form__input" 
                     onChange={e=>handleTimeSlotChange(e,index)}/>
                    </div>
                  </div>
                 <div className="flex items-center"></div>
                  <button onClick={e=>deleteTimeSlot(e,index)} className="bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 cursor-pointer mt-6"><AiOutlineDelete/></button>
                </div>
                </div>
          ...
          {formData.photo &&(<figure className="w-[60px] h-[60px] rounded-full 
                                ...
                                <div className="relative w-[130px] h-[50px]">
                                    ...
                                    <label
                                        ...
                                        flex items-center px-[0.75rem] py-[0.375rem] 
                                        text-[15px] leading-6 overflow-hidden bg-[#0066ff46] 
